...
const EditJob = ({ error, loading, jobs, editJob, id }) => {
  if (jobs) {
    return (
      <FormWrapper>
        <Formik
          initialValues={{
            ...
            earningsType: jobs.earningsType,
            location: jobs.location,
            contract: jobs.contract,
            employmentType: jobs.employmentType,
            interview: jobs.interview,
            timelapse: jobs.timelapse,
            responsibility: jobs.responsibility,
            ...
            <Form>
              ...
              <SubmitButtonWrapper>
                <Button
                  ...
                  loading={loading ? "Edytowanie oferty" : null}
                  type="submit"
                >
                  Dodaj oferte pracy
                </Button>
