        ...
        >
          {({ isSubmitting, isValid }) => (
            <FormWrapper>
              ...
              <Text>Po zmianie adresu email wyślemy na nowy adres wiadomość zawierającą link aktywacyjny. Nowy adres email stanie się Twoim loginem dopiero, kiedy klikniesz w link aktywacyjny.</Text>
              <Field word="Nowy e-mail" type="email" name="email" component={Input} long/>
              {/* <Field
                word="First Name"
                type="text"
                name="firstName"
